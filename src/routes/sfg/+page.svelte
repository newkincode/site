...
<meta content="sfg페이지입니다." property="og:description" />
<meta content="https://newkini-dev.com/sfg" property="og:url" />
<meta content="https://github.com/simple-farming-game/simple_farming_game/blob/main/assets/img/icon-512.png?raw=true" property="og:image" />
<meta content="#c22a0f" data-react-helmet="true" name="theme-color" />
</head>
<h1>Simple Farming Game 링크!</h1>
<a class="btn btn-light" href="https://github.com/simple-farming-game/simple_farming_game/releases"><button>다운로드(깃헙 릴리즈)</button></a><br>
<a class="btn btn-light" href="https://github.com/simple-farming-game/simple_farming_game"><button>깃허브</button></a><br>
